 	...
 	<tr>
 		<td>
 			<center>
 				...
 				<h1>
 					ABSENSI SISWA <br>
 					<small> SMK NU 03 BONDOWOSO</small>
 				</h1>
 				<hr>
 				<em>
 						Jl.Niaga Desa Nogosari Kecamatan Sukosari,<br> Kabupaten Bondowoso, Provinsi Jawa Timur, Kode Pos (68287) <br>
 				<b>Email : smknu3bws@gmail.com Telp.081266005679</b>
 				</em>
